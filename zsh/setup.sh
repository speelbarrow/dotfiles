...
ln -s $HOME/.oh-my-zsh/themes/typewritten/typewritten.zsh-theme $HOME/.oh-my-zsh/themes/typewritten.zsh-theme
ln -s $HOME/.oh-my-zsh/themes/typewritten/async.zsh $HOME/.oh-my-zsh/themes/async

# Install other plugins
for repo in "zsh-users/zsh-autosuggestions" "zsh-users/zsh-syntax-highlighting" "zsh-users/zsh-apple-touchbar"; do
	git clone "https://github.com/$repo" "$HOME/.oh-my-zsh/plugins/`basename $repo`"
done

# Add symlink for zsh-apple-touchbar (uses -f because I never want the default)
ln -sf $DOTFILES/zsh/zsh-apple-touchbar.zsh $HOME/.oh-my-zsh/plugins/zsh-apple-touchbar/zsh-apple-touchbar.zsh 
