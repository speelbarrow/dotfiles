...
if cmd_exists zsh && fs_exists "$HOME/.local/share/zsh/oh-my-zsh"; then
    ...
    git clone --depth 1 https://github.com/dracula/zsh.git "$HOME/.local/share/zsh/oh-my-zsh/custom/themes/dracula"
    ...
    for repo in zsh-autosuggestions zsh-syntax-highlighting; do
        git clone --depth 1 "https://github.com/zsh-users/$repo" "$HOME/.local/share/zsh/oh-my-zsh/custom/plugins/$repo"
    done
fi
